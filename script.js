...
const items = [
  ...
  { name: 'Điểm Đoạt Mạng – Ngô Hiểu Lạc', category: 'VienTuong', url: '#', imageUrl: 'https://ebookvie.com/wp-content/uploads/2025/10/diem-doat-mang.jpg' }, 
  { name: 'Lời Thề Tàn Nhẫn - Rebecca Ross', category: 'VienTuong', url: '#', imageUrl: 'https://ebookvie.com/wp-content/uploads/2025/10/loi-the-tan-nhan.jpg' },
  { name: '#', category: '#', url: '#', imageUrl: '#' },
  { name: '#', category: '#', url: '#', imageUrl: '#' }
